...
𝐍𝐚𝐦𝐞: Grey (the name of the character I am cosplaying is also fine)

𝐏𝐫𝐨𝐧𝐨𝐮𝐧𝐬: She/Her (the pronouns of the character I am cosplaying are also fine)
...
Likes/Interests: 2ha, adventure time (f&c), ALNST, all saints street, 𝐚𝐫𝐜𝐚𝐧𝐞 (𝐣𝐚𝐲𝐯𝐢𝐤), beastars, bee & puppycat, belfort&lupin, 𝐛𝐞𝐫𝐬𝐞𝐫𝐤 (golden age), bishounen detective club, chainsaw man, castlevania, copper coins, given, hakuouki, 𝐢𝐝𝐨𝐥𝐢𝐬𝐡𝟕 (𝐫𝐞:𝐯𝐚𝐥𝐞 & mezzo"), kamisama kiss, katsugeki touken, legend of the galactic heroes (LOGH), link click, 𝐥𝐨𝐭𝐫, mxtx (svsss, 𝐦𝐨𝐬𝐡𝐚𝐧𝐠), omori, oneshot, poker face, 𝐩𝐨 𝐲𝐮𝐧 (𝐁𝐓𝐭𝐂), psyborg🐑🔮, severance, sk8 (𝐦𝐚𝐭𝐜𝐡𝐚𝐛𝐥𝐨𝐬𝐬𝐨𝐦), soul eater, 𝐬𝐩𝐢𝐫𝐢𝐭𝐩𝐚𝐜𝐭, steven universe, sword of the stranger, tadc🃏, the legend of hei, the silmarillion, 𝐮𝐫𝐚𝐛𝐨𝐤𝐮, visual prison, voltron (+GoLion), 𝐲𝐚𝐦𝐢 𝐧𝐨 𝐦𝐚𝐭𝐬𝐮𝐞𝐢 (DoD) + MANY more! >:3
...
<img width="200" height="200" alt="Untitled115_20260208205258" src="https://github.com/user-attachments/assets/a30f39bf-3f79-4c4b-919f-28a7d0244209" />
<img width="200" height="200" alt="Untitled115_20260208205308" src="https://github.com/user-attachments/assets/1939f956-d0c9-44de-b073-b0c8f7a39db8" />
